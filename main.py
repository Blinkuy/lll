...
root.title("Нуну&Виллумп")

macro_on = False
start_button = tk.start_button = tk.Button(root, text="Старт макрос (f2)", command=start_macro)
start_button.pack()
stop_button = tk.Button(root, text="Стоп макрос (f4)", state="disable", command=stop_macro)
stop_button.pack()
